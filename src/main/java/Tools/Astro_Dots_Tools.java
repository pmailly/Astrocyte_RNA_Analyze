...
import static Astrocytes.Astro_Dots.maxNucSize;
import static Astrocytes.Astro_Dots.meanSEMDotsSize;
import static Astrocytes.Astro_Dots.minNucSize;
...
private static double somaDist = 2;
    ...
    public static ArrayList dialog(String[] channels, boolean showCal) {
        ...
        gd.addNumericField("Minimum volume size : ", minNucSize, 2);
        gd.addNumericField("Maximum volume size : ", maxNucSize, 2);
